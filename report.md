...
![результат программы readfile](image/07_1.png){ #fig:007 width=70% height=70%}

![результат программы readfile](image/07_2.png){ #fig:008 width=70% height=70%}
...
![исследование Sticky-бита](image/08.png){ #fig:009 width=70% height=70%}
