...
![результат программы readfile](image/07_1.png){ #fig:003 width=70% height=70%}

## Программа readfile

![результат программы readfile](image/07_2.png){ #fig:004 width=70% height=70%}

## Исследование Sticky-бита

![исследование Sticky-бита](image/08.png){ #fig:005 width=70% height=70%}
